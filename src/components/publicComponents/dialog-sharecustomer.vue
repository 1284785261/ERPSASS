...
<template>
  <div>
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="dialogVisible" destroy-on-close width="600px" :lock-scroll="false" custom-class="erpdialog" @close="closedialog">
      <div class="tree-box">
        <div class="left-box">
          ...
          <div class="choose-box">
            ...
            <el-tree :data="newarray" key="1" node-key="Id" ref="tree" v-loading="treeloading" show-checkbox default-expand-all :props="defaultProps" :expand-on-click-node="false" @check="handleCheckChange">
        ...
        <div class="rght-box">
          ...
          <div class="content-customer">
            <div v-for="(item, index) in checkList" :key="index">
              <el-checkbox v-model="item.ischecked" @change="choosechecked">
                {{item.name}}
              </el-checkbox>
              <svg-icon icon-class="setting" @click.stop="checkdelete(index, item)" />
            </div>
          </div>
          <div class="operate">
