      ...
      <div class="From-box-content">
				<el-form ref="ruleForm" :model="searchObject" :rules="Formrules" class="forms-Compensation">
						...
						<el-row :gutter="64">
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="规则名称" prop="RuleName" class="Compensation-header">
									<el-input v-model="searchObject.RuleName" disabled clearable size="small" placeholder="请选择规则名称" />
								</el-form-item>
							</el-col>
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="规则属性" prop="RuleProperties" class="Compensation-header">
									<el-select v-model="searchObject.RuleProperties" disabled clearable placeholder="请选择规则属性" size="mini"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" v-if="searchObject.RuleProperties=='1'">
								<el-form-item label="规则启用周期" prop="RuleEnablingPeriod" class="Compensation-header">
									<el-date-picker v-model="searchObject.RuleEnablingPeriod" disabled @change="PeriodTime" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" class="select-picker">
									</el-date-picker>
								</el-form-item>
							</el-col>
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="启用公司" prop="CompanyIds" class="Compensation-header">
									<el-select v-model="searchObject.CompanyIds" disabled remote clearable multiple placeholder="请选择启用公司"
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="提成业务类型" prop="RulebusinessType" class="Compensation-header">
									<el-select v-model="searchObject.RulebusinessType" disabled clearable placeholder="请选择提成业务类型" size="mini"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="营销人员属性" prop="RuleSaleType" class="Compensation-header">
									<el-select v-model="searchObject.RuleSaleType" disabled clearable placeholder="请选择营销人员属性" size="mini"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="是否为关联方客户" prop="IsRelation" class="Compensation-header">
									<el-select v-model="searchObject.IsRelation" disabled clearable placeholder="请选择是否为关联方客户"
										class="select-input">
						...
						<el-row :gutter="64">
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="招聘计提类型" prop="RecruitmentAccrualType" class="Compensation-header">
									<el-select v-model="searchObject.RecruitmentAccrualType" disabled clearable placeholder="请选择是否为关联方客户"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="招聘渠道类型" prop="RecruitmentChannelType" class="Compensation-header">
									<el-select v-model="searchObject.RecruitmentChannelType" disabled clearable placeholder="请选择是否为关联方客户"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="入职标准" prop="EntryCriteria" class="Compensation-header">
									<el-select v-model="searchObject.EntryCriteria" disabled clearable placeholder="请选择是否为关联方客户"
										class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="招聘计提方式" prop="RecruitmentAccrualMethod" class="Compensation-header">
									<el-select v-model="searchObject.RecruitmentAccrualMethod" disabled clearable placeholder="" class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" v-if='searchObject.RecruitmentAccrualMethod'>
								<el-form-item :label="searchObject.RecruitmentAccrualMethod == '0'?'按人天':'按人数'" prop="Person1People1Sky1" class="Compensation-header" >
									<div style="width:438px; display: flex;" >
										<el-select v-model="searchObject.AccrualOperation" disabled clearable placeholder="请选择是否为关联方客户" style="width:200px; margin-right:10px" class="select-input tops">
											<el-option v-for="item in OperationEnum" :key="item.value"
												:label="item.describe" :value="item.value">
											</el-option>
										</el-select>
										<el-input v-model="searchObject.AccrualP" type="number" disabled size="small" placeholder="" style="width:105px;margin-right:10px"  ><i slot="suffix" style="font-style:normal;color:#000000">人</i></el-input>
										<el-input v-model="searchObject.AccrualD" type="number" disabled size="small" placeholder="" style="width:105px" v-if="searchObject.RecruitmentAccrualMethod == '0'" ><i slot="suffix" style="font-style:normal;color:#000000">天</i></el-input>
									</div>
								</el-form-item>
							</el-col>
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="奖励金额" prop="RewardAmount" class="Compensation-header">
									<el-input v-model="searchObject.RewardAmount" type="number" disabled clearable size="small" placeholder="" ><i slot="suffix" style="font-style:normal;color:#000000">元</i></el-input>
								</el-form-item>
							</el-col>
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="是否设置奖励封顶" prop="RewardCapping" class="Compensation-header">
									<el-select v-model="searchObject.RewardCapping" disabled clearable placeholder=""
										class="select-input">
										<el-option v-for="item in relevancyList" :key="item.value"
											:label="item.label" :value="item.value">
										</el-option>
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" v-if='searchObject.RewardCapping=="1"'>
								<el-form-item :label="searchObject.RecruitmentAccrualMethod == '0'?'按人天':'按人数'" prop="Person2People2Sky2" class="Compensation-header">
									<div style="width:438px; display: flex;">
										<el-select v-model="searchObject.CappingOperation" disabled clearable placeholder="" style="width:200px; margin-right:10px" class="select-input tops">
											<el-option v-for="item in OperationEnum" :key="item.value"
												:label="item.describe" :value="item.value">
											</el-option>
										</el-select>
										<el-input v-model="searchObject.CappingP" type="number" disabled  size="small" placeholder="" style="width:105px;margin-right:10px"  ><i slot="suffix" style="font-style:normal;color:#000000">人</i></el-input>
										<el-input v-model="searchObject.CappingD" type="number" disabled  size="small" placeholder="" style="width:105px" v-if="searchObject.RecruitmentAccrualMethod == '0'"><i slot="suffix" style="font-style:normal;color:#000000">天</i></el-input>
									</div>
								</el-form-item>
							</el-col>
							 <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
								<el-form-item label="备注" class="text">
									<el-input type="textarea" :rows="5" maxlength="200" disabled show-word-limit v-model="searchObject.Remark"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
					</div>
					<div class="form-cont" v-if="searchObject.RulebusinessType!=0 && searchObject.RulebusinessType!=''">
						<el-row :gutter="64">
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="计提方式" prop="AccrualMethod" disabled class="Compensation-header">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="提成运算方式" prop="CommissionCalculationMethod" class="Compensation-header">
									<el-select v-model="searchObject.CommissionCalculationMethod" disabled clearable placeholder="" class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="提成结算方式" prop="CommissionSettlementMethod" disabled class="Compensation-header">
							...
							<div v-if="searchObject.CommissionSettlementMethod=='1'">
								<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
									<el-form-item label="递减比例/金额" prop="DecreasingOrAmount"  class="Compensation-header">
										<el-input v-model="searchObject.DecreasingOrAmount" clearable disabled size="small" placeholder="" ></el-input>
									</el-form-item>
								</el-col>
								<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
									<el-form-item label="递减最小比例/值" prop="DecreasingValue" class="Compensation-header">
										<el-input v-model="searchObject.DecreasingValue" disabled clearable size="small" placeholder="" ></el-input>
									</el-form-item>
								</el-col>
							</div>
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="预扣风险金计提方式" prop="WithdrawalMethod" class="Compensation-header">
									<el-select v-model="searchObject.WithdrawalMethod" disabled clearable placeholder="" class="select-input">
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="预扣风险金运算方式" prop="WithdrawalOperationMethod" class="Compensation-header">
									<el-select v-model="searchObject.WithdrawalOperationMethod" disabled clearable placeholder="" class="select-input">
										<el-option v-for="item in CommisionRuleEnumCommisionType" :key="item.value"
											:label="item.describe" :value="item.value">
										</el-option>
									</el-select>
							...
							<el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
								<el-form-item label="预扣风险金比例/金额" prop="WithdrawalProportionalOrAmount" class="Compensation-header">
									<el-input v-model="searchObject.WithdrawalProportionalOrAmount" disabled clearable size="small" placeholder="" ></el-input>
								</el-form-item>
							</el-col>
						</el-row>
					</div>
...
import { GetCommisionRuleInfo, GetCommisionRuleAllEnum, GetBfCompanyPageList } from '@/api/BusinessSet.js'
...
export default {
  ...
  data () {
    return {
      urlList: [{
        name: '营销提成规则设置',
        router: '/BusinessSet/MarketingCommissionRules'
      }, {
        name: '查看营销提成规则',
        router: ''
      }],
				...
				GetCommisionRuleInfo(qs.stringify(data)).then(response => {
					if (response.IsSuccess && response.Data) {
						...
						if(data.CommisionRuleFullRecruitment){
							let v=this.searchObject
							v.RecruitmentAccrualType=data.CommisionRuleFullRecruitment.RecruitmentAccrualType
							v.RecruitmentChannelType=data.CommisionRuleFullRecruitment.RecruitmentChannelType//招聘渠道类型
							v.EntryCriteria = data.CommisionRuleFullRecruitment.EntryCriteria//入职标准
							v.RewardAmount = data.CommisionRuleFullRecruitment.RewardAmount//奖励金额
							v.RecruitmentAccrualMethod = String(data.CommisionRuleFullRecruitment.RecruitmentAccrualMethod)//是否设置奖励封顶
							v.AccrualOperation = data.CommisionRuleFullRecruitment.AccrualOperation//安人天
							v.AccrualP = data.CommisionRuleFullRecruitment.AccrualP
							v.AccrualD = data.CommisionRuleFullRecruitment.AccrualD//天
							v.CappingOperation = data.CommisionRuleFullRecruitment.CappingOperation
							v.CappingP = data.CommisionRuleFullRecruitment.CappingP
							v.CappingD = data.CommisionRuleFullRecruitment.CappingD
							v.RewardCapping = data.CommisionRuleFullRecruitment.RewardCapping
							v.Remark = data.CommisionRuleFullRecruitment.Remark//备注
								
						}
						if(data.CommisionRuleOtherBusinessType){
							let v=this.searchObject
							v.AccrualMethod = data.CommisionRuleOtherBusinessType.AccrualMethod
							v.CommissionCalculationMethod = data.CommisionRuleOtherBusinessType.CommissionCalculationMethod
							v.ProportionalOrAmount = data.CommisionRuleOtherBusinessType.ProportionalOrAmount
							v.CommissionSettlementMethod = data.CommisionRuleOtherBusinessType.CommissionSettlementMethod
							v.DecreasingOrAmount = data.CommisionRuleOtherBusinessType.DecreasingOrAmount
							v.DecreasingValue = data.CommisionRuleOtherBusinessType.DecreasingValue
							v.WithdrawalMethod = data.CommisionRuleOtherBusinessType.WithdrawalMethod
							v.WithdrawalOperationMethod = data.CommisionRuleOtherBusinessType.WithdrawalOperationMethod
							v.WithdrawalProportionalOrAmount = data.CommisionRuleOtherBusinessType.WithdrawalProportionalOrAmount
