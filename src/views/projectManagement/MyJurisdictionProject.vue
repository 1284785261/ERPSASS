    ...
    <div class="table-content">
      <div>
        <div class="tab clearfix">
          ...
          <el-button class="operation-button tableHeader-button erpbtn" size="small" @click="updateprincipal">修改业务负责人</el-button> -->
        </div>
                ...
                <el-dropdown trigger="click" v-if="$operatebtns(operates, ['Modify', 'AddCommunication', 'BusinessCommissionSet', 'MessageFeedback', 'ApplyBuyTenderDocument', 'SubmitQuotationReview', 'ServiceCommissionSet', 'RecommendOfficer', 'InitiatingRecruitmentService', 'AddRemind', 'AssignProjectLeader'])">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <ul class="popout-list">
                      ...
                      <!-- <el-dropdown-item @click.native="updateadmin(scope.row,'SetRights')">修改项目管理员</el-dropdown-item> -->
                      ...
                      <!-- <el-dropdown-item @click.native="updateprincipal(scope.row,'SetRights')">修改业务负责人</el-dropdown-item> -->
                    </ul>
                  </el-dropdown-menu>
                </el-dropdown>
...
import appointee from "@/components/publicComponents/dialog-appointee";
...
export default {
  ...
  methods: {
    ...
    getProjectList() {
      ...
      GetMyRightProjectList(qs.stringify(obj)).then(response => {
    ...
    saveappointee(e) {
      ...
      if (this.IsAdmin) {
        ...
        showLoading();
        EditProjectSysUser(qs.stringify(obj)).then(response => {
          hideLoading();
          if (response.IsSuccess) {
            this.$message({
              type: "success",
