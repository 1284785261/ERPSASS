...
<template>
  <div class="industry-box">
    ...
    <div class="table-content">
      <div>
        <el-table ref="industrtTable" v-loading="tableloading" :data="OperationlogList" class="role-table" style="width: 100%;margin-bottom: 20px;" tooltip-effect="dark">
          <el-table-column align="center" prop="UserID" label="登录账号" />
          <el-table-column align="center" prop="MenuOperationId" label="菜单操作ID" />
          <el-table-column align="center" prop="MenuOperationName" label="菜单操作" />
          <el-table-column align="center" prop="Description" label="操作描述" />
...
<script>
import { SysMgrLogPageList } from '@/api/SystemSetting.js'
...
export default {
  ...
  methods: {
    getData () {
      ...
      SysMgrLogPageList(obj).then(res => {
