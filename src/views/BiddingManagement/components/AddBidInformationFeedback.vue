  ...
  <div class="AddBidInformationFeedback-Box">
    ...
    <div class="form-content">
      <el-form ref="ruleForm" label-position="top" :model="dataObject" :rules="Formrules" label-width="140px" class="projectform">
        <div class="form-title" v-if="this.BiddingInformation.name != '上传标书附件'">
          第一阶段
        </div>
        <div class="form-cont" v-if="this.BiddingInformation.name != '上传标书附件'">
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="招标单位" prop="BiddingUnit">
                <el-select v-model="dataObject.BiddingUnit" size="small" clearable :disabled="disabled" @click.native="remoteCompany('')" :remote-method="remoteCompany" @clear="clearCompany" filterable remote placeholder="请选择所属客户" :loading="loading" class="select-input">
            ...
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="项目名称" prop="ProjectName">
                <el-select v-model="dataObject.ProjectName" size="small" clearable :disabled="disabled" :remote-method="remoteProject" @clear="clearProject" filterable remote placeholder="请选择项目名称" :loading="loading" class="select-input">
            ...
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="开标截止时间" prop="BuyBidClosingTime" class="Date">
                <el-date-picker v-model="dataObject.BuyBidClosingTime" size="small" value-format="yyyy-MM-dd HH:mm:ss" clearable :disabled="disabled" type="datetime" placeholder="请选择开标截止时间">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
          ...
          <el-select v-model="dataObject.BusinessType" :disabled="disabled" clearable filterable remote placeholder="请查询或下拉招标被授权人" :loading="loading" class="select-input">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="项目招标文件附件上传" v-model="dataObject.Files" prop="Files" class="recipientPhone file">
                ...
                <div class="upload" v-if="this.BiddingInformation.name != '查看标前标后信息反馈'">
                ...
                <div class="babel" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
                  ...
                  <div class="upload">
                    <div class="files" @mouseenter="fileShow()" @mouseleave="filenoShow()">
                      ...
                      <p>{{ fileName }}</p>
                      <div v-show="optionShow" class="option-button">
                        <div @click="preview(dataObject.Files)">
                          <i class="el-icon-view"></i>
                          <span>预览</span>
                        </div>
                        <div @click="DownLoad(dataObject.Files)">
        ...
        <div class="form-title" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
          第三阶段
        </div>
        <div class="form-cont" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="招投标评估意见" class="text">
                <el-input v-model="dataObject.BiddingEvaluationOpinions" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="业务主管领导意见" class="text">
                <el-input v-model="dataObject.OpinionsBusinessLeaders" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="营销分管领导意见" class="text">
                <el-input v-model="dataObject.OpinionsLeadersChargeMarketing" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="招投标中心分管领导意见" class="text">
                <el-input v-model="dataObject.BiddingOpinions" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="公司领导意见" class="text">
                <el-input v-model="dataObject.OpinionsCompanyLeaders" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="招投标协同" class="recipientPhone">
                <el-input v-model="dataObject.BiddingCollaboration" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="项目招投标负责人" class="recipientPhone">
                <el-input v-model="dataObject.ProjectPersonCharge" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="技术方案负责人" class="recipientPhone">
                <el-input v-model="dataObject.TechnicalProposalLeader" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
          ...
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <div class="operate-table">
                <div class="TableTitle">授权代表</div>
                <el-table ref="multipleTable" class="erp-table" v-loading="tableloading" :data="tableData" tooltip-effect="dark">
                  <el-table-column align="center" prop="Id" label="序号" min-width="60" />
                  <el-table-column align="center" prop="BidderCompany" label="投标人（按报价从低到高排序）" min-width="180" />
                  <el-table-column align="center" prop="QuotedPrice" label="报价（万元）" min-width="120" show-overflow-tooltip />
                  <el-table-column align="center" prop="Remark" label="备注" min-width="120" show-overflow-tooltip />
                </el-table>
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="中落标情况">
                <el-input v-model="dataObject.WinningFallingBid" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="中标单位" class="text">
                <el-input v-model="dataObject.BidWinner" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="中标毛利润">
                <el-input v-model="dataObject.BidWinningGrossProfit" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="中落标结果分析（跟单员）" class="text">
                <el-input v-model="dataObject.ResultsAnalysis" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
        ...
        <div class="form-cont" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="中落标分析/收获">
                <el-input v-model="dataObject.AnalysisAndHarvest" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="中落标其他情况">
                <el-input v-model="dataObject.BiddingOtherSituations" clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="投保金催退">
                <el-radio v-model="dataObject.InsuranceDepositRefund" :disabled="disabled" label="0">无</el-radio>
                <el-radio v-model="dataObject.InsuranceDepositRefund" :disabled="disabled" label="1">已退回</el-radio>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="退回金额">
                <el-input v-model="dataObject.ReturnAmount" clearable :disabled="disabled" size="small">
            ...
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="退回时间">
                <el-date-picker v-model="dataObject.ReturnTime" clearable :disabled="disabled" type="datetime" size="small">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
              <el-form-item label="协助投标" class="recipientMan">
                <el-radio v-model="dataObject.AssistBidding" :disabled="disabled" label="0">无</el-radio>
                <el-radio v-model="dataObject.AssistBidding" :disabled="disabled" label="1">有</el-radio>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="其他费用" class="recipientPhone">
                <el-input v-model="dataObject.OtherExpenses" :disabled="disabled" clearable size="small">
                  <svg-icon slot="suffix" icon-class="money" class-name="way" />
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="其他情况" class="text">
                <el-input v-model="dataObject.OtherSituations" type="textarea" resize="none" :rows="5" maxlength="100" show-word-limit :disabled="disabled" size="small" />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="其他情况说明" class="text">
                <el-input v-model="dataObject.OtherInformation" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="退回凭证附件">
                <div v-if="
                    this.BiddingInformation.name == '查看标前标后信息反馈' &&
                    dataObject.ReturnVoucherAttachment != null
                  " class="recipientPhone file">
                  <div class="upload">
                    <div class="files" @mouseenter="fileShow()" @mouseleave="filenoShow()">
                      <span class="filestype">{{ filestypes }}</span>
                      <p>{{ fileNames }}</p>
                      <div v-show="optionShow" class="option-button">
                        <div @click="preview(dataObject.ReturnVoucherAttachment)">
                          <i class="el-icon-view"></i>
                          <span>预览</span>
                        </div>
                        <div @click="DownLoad(dataObject.ReturnVoucherAttachment)">
                          <i class="el-icon-download"></i>
                          <span>下载</span>
                        </div>
                      </div>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <div class="operate-table">
                <div class="TableTitle">协助投标情况</div>
                <el-table ref="multipleTable" class="erp-table" v-loading="tableloading" :data="AssistanceBiddingData" tooltip-effect="dark">
                  <el-table-column align="center" prop="Id" label="序号" min-width="60" />
                  <el-table-column align="center" prop="AssistCompany" label="选手（公司名称）" min-width="180" />
                  <el-table-column align="center" prop="BusinessDirector" label="商务负责人" min-width="120" show-overflow-tooltip />
                  <el-table-column align="center" prop="TechnicalDirector" label="技术负责人" min-width="120" show-overflow-tooltip />
                </el-table>
              </div>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <div class="operate-table">
                <div class="TableTitle">投标过程费用</div>
                <el-table ref="multipleTable" class="erp-table" v-loading="tableloading" :data="CostBiddingProcess" tooltip-effect="dark">
                  <el-table-column align="center" prop="Id" label="序号" min-width="60" />
                  <el-table-column align="center" prop="CostContent" label="费用内容" min-width="180" />
                  <el-table-column align="center" prop="Price" label="单价（元）" min-width="120" show-overflow-tooltip />
                  <el-table-column align="center" prop="Number" label="数量（个）" min-width="120" show-overflow-tooltip />
                </el-table>
              </div>
            </el-col>
          </el-row>
        ...
        <div class="form-cont" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
              <el-form-item label="项目进度确认">
                <el-radio v-model="dataObject.BiddingProjectStatus" :disabled="disabled" label="1">完结</el-radio>
                <el-radio v-model="dataObject.BiddingProjectStatus" :disabled="disabled" label="2">待完善</el-radio>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="整改内容" class="text">
                <el-input v-model="dataObject.RectificationContent" resize="none" type="textarea" :rows="5" maxlength="1000" show-word-limit clearable :disabled="disabled" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
        <div class="form-title" v-if="
            this.BiddingInformation.name == '查看标前标后信息反馈' ||
            this.BiddingInformation.name == '上传标书附件'
          ">
          标书附件
        </div>
        <div class="form-cont" v-if="
            this.BiddingInformation.name == '查看标前标后信息反馈' ||
            this.BiddingInformation.name == '上传标书附件'
          ">
          <el-row :gutter="64">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="投标文件附件" v-model="dataObject.BiddingBookAttachUrl" class="recipientPhone file">
                <div class="tip">
                  上传附件文件大小不超过300M,上传格式PNG.JPG.Word.PDF.XLSX.XLS.ZIP.RAR
                </div>
                <div class="file-cont" v-loading="fileloading" v-if="this.BiddingInformation.name == '上传标书附件'">
                  <div class="img-box-list" v-if="dataObject.BiddingBookAttachUrl.length > 0" v-for="(item, index) in dataObject.BiddingBookAttachUrl" :key="index" @mouseenter="item.visible = !item.visible" @mouseleave="item.visible = !item.visible">
                    <!-- 上传文件成功后展示 -->
                    <div class="img-box">
                      <span class="filetype">{{ item.name }}</span>
                      <div class="filename" :title="item.Url">
                        {{ item.Url }}
                      </div>
                    </div>
                    <div class="img-box-hover" v-show="item.visible == true">
                      <div class="btn">
                        <input type="file" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="uploadfile($event, index)" />
                  ...
                  <div class="img-box-list" v-if="this.BiddingInformation.name == '上传标书附件'">
                    <!-- 未上传样式 -->
                    <input type="file" ref="upload" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="uploadfile" />
                    <div class="img-box">
                      <img src="@/assets/down.png" alt="" />
                    </div>
                  </div>
                </div>
                <div class="file-cont" v-loading="fileloading" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
                  <div class="img-box-list" v-if="dataObject.BiddingBookAttachUrl.length > 0" v-for="(item, index) in dataObject.BiddingBookAttachUrl" :key="index" @mouseenter="item.visible = !item.visible" @mouseleave="item.visible = !item.visible">
                    <!-- 上传文件成功后展示 -->
                    <div class="img-box">
                      <span class="filetype">{{ item.name }}</span>
                    ...
                    <div class="img-box-hover" v-show="item.visible == true">
                      <div class="btn" @click="preview(item.Url)">
                        <svg-icon icon-class="replace" class-name="svg-a" />
                        <span>预览</span>
                      </div>
                      <div class="btn" @click="DownLoad(item.Url)">
                        <svg-icon icon-class="download" class-name="svg-a" />
                        <span>下载</span>
                      </div>
                    </div>
                  </div>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="中标文件附件" v-model="dataObject.WinningBookAttachUrl" class="recipientPhone file">
                <div class="tip">
                  上传附件文件大小不超过300M,上传格式PNG.JPG.Word.PDF.XLSX.XLS.ZIP.RAR
                </div>
                <div class="file-cont" v-loading="Mldfileloading" v-if="this.BiddingInformation.name == '上传标书附件'">
                  <div class="img-box-list" v-if="dataObject.WinningBookAttachUrl.length > 0" v-for="(item, index) in dataObject.WinningBookAttachUrl" :key="index" @mouseenter="item.visible = !item.visible" @mouseleave="item.visible = !item.visible">
                    <!-- 上传文件成功后展示 -->
                    <div class="img-box">
                      <span class="filetype">{{ item.name }}</span>
                      <div class="filename" :title="item.Url">
                    ...
                    <div class="img-box-hover" v-show="item.visible == true">
                      <div class="btn">
                        <input type="file" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="MiddleUploadFile($event, index)" />
                        <svg-icon icon-class="replace" class-name="svg-a" />
                        <span>替换</span>
                      </div>
                      <div class="btn" @click="MiddleDeletefile(index)">
                        <svg-icon icon-class="del" class-name="svg-a" />
                        <span>删除</span>
                      </div>
                    </div>
                  ...
                  <div class="img-box-list" v-if="this.BiddingInformation.name == '上传标书附件'">
                    <!-- 未上传样式 -->
                    <input type="file" ref="MdlUpload" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="MiddleUploadFile" />
                    <div class="img-box">
                      <img src="@/assets/down.png" alt="" />
                    </div>
                  </div>
                </div>
                <div class="file-cont" v-loading="Mldfileloading" v-if="this.BiddingInformation.name == '查看标前标后信息反馈'">
                  <div class="img-box-list" v-if="dataObject.WinningBookAttachUrl.length > 0" v-for="(item, index) in dataObject.WinningBookAttachUrl" :key="index" @mouseenter="item.visible = !item.visible" @mouseleave="item.visible = !item.visible">
                    <!-- 上传文件成功后展示 -->
                    <div class="img-box">
                      <span class="filetype">{{ item.name }}</span>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              <el-form-item label="过程材料附件" v-model="dataObject.ProcessMaterialsAttachUrl" class="recipientPhone file">
                <div class="tip">
                  上传附件文件大小不超过300M,上传格式PNG.JPG.Word.PDF.XLSX.XLS.ZIP.RAR
                </div>
                <div class="file-cont" v-loading="Btmfileloading" v-if="this.BiddingInformation.name == '上传标书附件'">
                  <div class="img-box-list" v-if="dataObject.ProcessMaterialsAttachUrl.length > 0" v-for="(
                      item, index
                    ) in dataObject.ProcessMaterialsAttachUrl" :key="index" @mouseenter="item.visible = !item.visible" @mouseleave="item.visible = !item.visible">
                    <!-- 上传文件成功后展示 -->
                    <div class="img-box">
                      <span class="filetype">{{ item.name }}</span>
                      <div class="filename" :title="item.Url">
                    ...
                    <div class="img-box-hover" v-show="item.visible == true">
                      <div class="btn">
                        <input type="file" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="BottomUploadFile($event, index)" />
                        <svg-icon icon-class="replace" class-name="svg-a" />
                        <span>替换</span>
                      </div>
                      <div class="btn" @click="BottomDeletefile(index)">
                        <svg-icon icon-class="del" class-name="svg-a" />
                        <span>删除</span>
                      </div>
                    </div>
                  ...
                  <div class="img-box-list" v-if="this.BiddingInformation.name == '上传标书附件'">
                    <!-- 未上传样式 -->
                    <input type="file" ref="BtmUpload" accept=".doc,.docx,.pdf,.png,.jpg,.xls,.xlsx,.zip,.rar" name="" id="" @change="BottomUploadFile" />
                    <div class="img-box">
                      <img src="@/assets/down.png" alt="" />
                    </div>
                  </div>
    ...
    <div class="footer-button" v-if="
        this.BiddingInformation.name == '添加标前标后信息反馈' ||
        this.BiddingInformation.name == '修改标前标后信息反馈'
      ">
...
export default {
  ...
  created() {
    ...
    if (this.BiddingInformation.name == "添加标前标后信息反馈") {
    ...
    } else if (this.BiddingInformation.name == "查看标前标后信息反馈") {
      this.urlList = [
        {
          name: "标前、标后信息管理",
          router: "/BiddingManagement/BiddingFileManagement"
      ...
      this.$nextTick(() => {
        this.GetBiddingInformationInfo();
      });
    ...
    } else if (this.BiddingInformation.name == "上传标书附件") {
      this.urlList = [
        {
          name: "标前、标后信息管理",
          router: "/BiddingManagement/BiddingFileManagement"
  ...
  methods: {
    ...
    MiddleDeletefile(index){
      this.dataObject.WinningBookAttachUrl.splice(index, 1);
    },
    BottomDeletefile(index){
      this.dataObject.ProcessMaterialsAttachUrl.splice(index, 1);
    },
    deletefile(index) {
      ...
      this.$refs[e].validate(valid => {
        if (valid) {
          let obj = {
           ...
           if(this.Business==''&&this.dataObject.AuthorizedRepresentative==''&&this.dataObject.DocumentaryAnalysis==''&&this.dataObject.RiskAssessment==''&&this.dataObject.ProfitEvaluation==''&&this.dataObject.ImportantAndDifficult==''&&this.dataObject.ParticipateBidding==''&&this.dataObject.BiddingFileRequirements==''){
            obj.BiddingInformationTwo=null
          }
          if (this.BiddingInformation.name == "添加标前标后信息反馈") {
