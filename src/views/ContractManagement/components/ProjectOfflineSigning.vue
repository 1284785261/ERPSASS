    ...
    <el-dialog :close-on-click-modal="false" title="线下签约合同上传" class="dialog-box" append-to-body :visible.sync="showEmployees" :show-close="false" :destroy-on-close="true" width="480px" @close="close">
      ...
      <el-form ref="ruleForm" :model="dataObject" :rules="Formrules" class="forms">
        <el-form-item label="所属项目" prop="ProjectName">
          <el-input v-model="dataObject.ProjectName" disabled placeholder=" " size="small" />
        </el-form-item>
        <el-form-item label="签约客户" prop="CompanyName">
          <el-input v-model="dataObject.CompanyName" disabled placeholder=" " size="small" />
        </el-form-item>
        <el-form-item label="合同金额" prop="Amount">
          <el-input v-model="dataObject.Amount" disabled placeholder=" " size="small">
...
export default {
  ...
  watch: {
    showEmployeesOffline (newvalue, oldvalue) {
      ...
      this.dataObject.ProjectName = this.tempData.ProjectName
      this.dataObject.CompanyName = this.tempData.CompanyName
      this.dataObject.Amount = this.tempData.Amount
    }
  },
  created () {
